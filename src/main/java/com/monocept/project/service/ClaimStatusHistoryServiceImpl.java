...
public class ClaimStatusHistoryServiceImpl implements ClaimStatusHistoryService {
    ...
    public PaginatedResponseDTO<ClaimStatusHistoryResponseDTO> getHistoryByClaimId(
        ...
        // A missing claim is a 404 for every role; a claim with no history yet is
        // just an empty page (list APIs return pagination metadata, not 404).
    ...
    private Pageable createPageable(
        ...
        if (direction == null
            ...
            log.warn("LOG-017 Invalid pagination request. Sort direction: {}", direction);
