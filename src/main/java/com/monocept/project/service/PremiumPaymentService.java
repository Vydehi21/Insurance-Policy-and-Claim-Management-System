...
public interface PremiumPaymentService {
    ...
    PaginatedResponseDTO<PremiumPaymentResponseDTO> searchPaymentsByReference(String reference, PaymentStatus status, int page, int size, String sortBy, String direction);
