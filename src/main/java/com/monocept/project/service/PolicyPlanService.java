...
public interface PolicyPlanService {
    ...
    /** Active plans under an active product only; empty when the product is inactive. */
    PaginatedResponseDTO<PolicyPlanResponseDTO> getPurchasablePlansByProductId(Long productId, int page, int size, String sortBy, String direction);
}