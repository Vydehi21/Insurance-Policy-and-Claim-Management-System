...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleOptimisticLocking(
        ...
        return buildResponse(HttpStatus.CONFLICT,
                "This record was updated by someone else in the meantime. Please reload and try again.",
                request.getRequestURI());
    }

    @ExceptionHandler(com.twilio.exception.ApiException.class)
    public ResponseEntity<ErrorResponseDTO> handleTwilioApiException(
            com.twilio.exception.ApiException ex, HttpServletRequest request) {
        log.error("Twilio API error (code {}): {}", ex.getCode(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponseDTO> handleMaxUploadSizeExceeded(
        ...
        log.warn("Upload rejected. Request exceeded the server's outer multipart size cap: {}", ex.getMessage());
        return buildResponse(HttpStatus.BAD_REQUEST, "File is too large to upload.", request.getRequestURI());
    }
