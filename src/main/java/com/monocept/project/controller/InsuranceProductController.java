...
public class InsuranceProductController {
    ...
    public ResponseEntity<PaginatedResponseDTO<InsuranceProductResponseDTO>> getAllProducts(
        ...
        // FR-PRD-004: customers only ever see active products. Previously this
        // returned inactive products to customers as well.
        if (userDetails != null && "CUSTOMER".equals(userDetails.getRole())) {
            return ResponseEntity.ok(
                    productService.getProductsByStatus(true, page, size, sortBy, direction));
        }
