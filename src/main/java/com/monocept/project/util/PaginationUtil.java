...
public class PaginationUtil {
    ...
    // Previously a second, looser implementation: an invalid direction such as
    // "sideways" silently sorted ascending on claims/policies/payments while
    // users/customers/products/plans rejected it. Both now share one rule set.
    public static Pageable buildPageable(int page, int size, String sortBy, String direction) {
        return createPageable(page, size, sortBy, direction);
    }
}