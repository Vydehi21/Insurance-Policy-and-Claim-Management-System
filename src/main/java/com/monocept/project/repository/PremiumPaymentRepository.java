...
public interface PremiumPaymentRepository extends JpaRepository<PremiumPayment, Long> {
    ...
    Page<PremiumPayment> findByTransactionReferenceContainingIgnoreCaseAndPaymentStatus(
            String transactionReference, PaymentStatus paymentStatus, Pageable pageable);
